...
if($query)
{
$msg="Post Image has been successfully changed.";
}
else{
$error="Error!";    
} 
                        ...
                        <div class="row">
							<div class="col-xs-12">
                                <ul class="breadcrumb wizard">
                                    ...
                                    <li class="completed"><a href="javascript:void(0);">Change Post Image </a></li>
                                </ul>
							</div>
						</div>
                        <!-- end row -->
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Choose New Image</b></h4>
